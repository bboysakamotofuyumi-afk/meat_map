...
このリポジトリは `docs/` を Pages 配信ディレクトリとして想定しています。CSV を `docs/output/meatmap.csv` にコピーし、`docs/map_demo.html` から参照します。
...
4. 公開URL  
   `https://<GitHubユーザー名>.github.io/meat_map/docs/map_demo.html?csv=output/meatmap.csv`
   - リポジトリ名が異なる場合は書き換える。
